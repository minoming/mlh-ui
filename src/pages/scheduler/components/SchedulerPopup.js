...
import { openPopupState, schedulerInfoState, requiredValueErrorState } from '../atoms/SchedulerPopupAtom'
...
export const SchedulerPopup = () => {
  ...
  const [requiredValueError, setRequiredValueError] = useRecoilState(requiredValueErrorState)
      ...
      <Dialog open={openPopup} onClose={handleClose}>
        ...
        <DialogContent style={{ width: '500px', height: '300px' }}>
          ...
          <FormControl fullWidth variant="outlined" margin="dense">
            <InputLabel required id="cron-expression-select-label">스케줄러 주기(Cron Expression)</InputLabel>
            <Select
